...
#define CXL_RQ_SIZE LLC_RQ_SIZE
#define CXL_WQ_SIZE LLC_WQ_SIZE
#define CXL_PQ_SIZE LLC_PQ_SIZE
...
#define PFB_RQ_SIZE LLC_RQ_SIZE
#define PFB_WQ_SIZE LLC_WQ_SIZE
#define PFB_PQ_SIZE LLC_PQ_SIZE
#define PFB_MSHR_SIZE LLC_MSHR_SIZE
